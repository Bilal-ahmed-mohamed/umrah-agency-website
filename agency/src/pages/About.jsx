...
const About = () => {
  return (
    ...
    <section className='py-12 '>
        <div className=' bg-cyan-700  w-full  mx-auto flex flex-wrap justify-evenly gap-4 border border-red-500 py-5 lg:w-3/4  '>
    ...
    <section className=' bg-fuchsia-800 h-screen w-full lg:h-96 ' >
        <div className=' bg-red-600 w-4/5 flex justify-evenly   lg:w-3/4 mx-auto h-screen lg:h-96 lg:flex flex-col lg:justify-center items-center'>
            <div className=' bg-indigo-600  h-60 lg:h-40 flex flex-col gap-5'>
            ...
            <div className='bg-lime-600  h-72 lg:h-40 flex flex-col gap-5'>
